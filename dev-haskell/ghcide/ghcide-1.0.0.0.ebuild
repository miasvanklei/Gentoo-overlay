...
SLOT="0/${PV}"
KEYWORDS="~amd64 ~x86"
IUSE="bench-exe executable ghc-patched-unboxed-bytecode test-exe"
...
RDEPEND="dev-haskell/aeson:=[profile?]
	...
	test-exe? ( >=dev-haskell/lsp-test-0.13.0.0:=[profile?]
...
PATCHES=(
	"${FILESDIR}"/ghcide-1.0.0.0-add-exe-flags.patch
)

src_prepare() {
	dos2unix ghcide.cabal
...
src_configure() {
	haskell-cabal_src_configure \
		$(cabal_flag ghc-patched-unboxed-bytecode ghc-patched-unboxed-bytecode)

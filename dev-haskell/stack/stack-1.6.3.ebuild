...
RDEPEND=">=dev-haskell/aeson-1.0:=[profile?] <dev-haskell/aeson-1.2:=[profile?]
	...
	>=dev-haskell/ansi-terminal-0.7.1.1:=[profile?] <dev-haskell/ansi-terminal-0.8.1:=[profile?]
	...
	dev-haskell/bindings-uname:=[profile?]
	>=dev-haskell/blaze-builder-0.4.0.2:=[profile?] <dev-haskell/blaze-builder-0.5:=[profile?]
	>=dev-haskell/cabal-2.0.1.0:=[profile?] <dev-haskell/cabal-2.1:=[profile?]
	...
	>=dev-haskell/hpack-0.21.0:=[profile?] <dev-haskell/hpack-0.22:=[profile?]

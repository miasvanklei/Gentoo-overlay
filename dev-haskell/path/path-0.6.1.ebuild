...
DEPEND="${RDEPEND}
	...
	test? ( >=dev-haskell/genvalidity-0.3 <dev-haskell/genvalidity-0.4
		>=dev-haskell/genvalidity-property-0.0 <dev-haskell/genvalidity-property-0.1
		>=dev-haskell/hspec-2.0 <dev-haskell/hspec-3
		>=dev-haskell/mtl-2.0 <dev-haskell/mtl-3
		dev-haskell/quickcheck
		>=dev-haskell/validity-0.3.1.1 <dev-haskell/validity-0.4 )
"

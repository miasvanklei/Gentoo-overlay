...
CABAL_CHDEPS=(
        "ghc-exactprint >= 1.4.0 && < 1.5" "ghc-exactprint >= 1.4.0 && < 1.6"
	"optparse-applicative >= 0.15.1 && < 0.17" "optparse-applicative >= 0.15.1 && < 0.19"
)
...
RDEPEND=">=dev-haskell/ansi-terminal-0.10.3:=[profile?] <dev-haskell/ansi-terminal-0.12:=[profile?]
	...
	>=dev-haskell/ghc-exactprint-1.4.0:=[profile?] <dev-haskell/ghc-exactprint-1.6.0:=[profile?]
	...
	>=dev-lang/ghc-8.4.3:=
	>=dev-lang/ghc-8.8:=[profile?] <dev-lang/ghc-9.4:=[profile?]

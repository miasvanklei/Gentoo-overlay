...
SLOT="0"
IUSE="build caps +cramfs fdformat kill ncurses nls pam python +readline selinux slang static-libs +suid systemd +thread-local-storage test tty-helpers udev unicode"
...
multilib_src_configure() {
	...
	local myeconfargs=(
		...
		$(use_enable thread-local-storage tls)

...
inherit eutils flag-o-matic toolchain-funcs multilib unpacker multiprocessing pax-utils autotools
...
src_unpack() {
	unpacker
	cd "${S}"
	epatch "${FILESDIR}"/${P}-execvpe.patch
	epatch "${FILESDIR}"/${P}-exec-hash.patch

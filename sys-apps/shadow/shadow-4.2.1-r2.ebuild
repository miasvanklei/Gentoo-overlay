...
IUSE="acl audit cracklib nls nscd pam selinux skey xattr"
...
DEPEND="${RDEPEND}
	...
	nls? ( sys-devel/gettext )
        nscd? ( elibc_musl? ( sys-libs/musl-nscd ) )"
RDEPEND="${RDEPEND}
...
PATCHES=(
	...
	"${FILESDIR}"/include-functions.patch
)
...
src_install() {
	...
	#   remove it.
	rm -f "${ED}"/{,usr/}$(get_libdir)/lib{misc,shadow}.la

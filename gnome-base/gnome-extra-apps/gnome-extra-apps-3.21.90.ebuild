...
RDEPEND="
	...
	>=media-gfx/gnome-font-viewer-3.20.2
	>=media-gfx/gnome-screenshot-3.20.1
	>=media-sound/sound-juicer-${PV}
	>=media-video/cheese-3.21.3
	>=net-analyzer/gnome-nettool-3.8
	>=net-misc/vinagre-3.21.3
	>=net-misc/vino-3.20.2
	>=sys-apps/baobab-${PV}

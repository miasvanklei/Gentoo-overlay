...
SRC_URI="https://github.com/crystal-lang/crystal/archive/${PV}.tar.gz -> ${P}.tar.gz
	!system-crystal? ( amd64? ( https://github.com/crystal-lang/crystal/releases/download/${PV}/crystal-${BV_AMD64}.tar.gz )
...
src_compile() {
	emake \
		...
		AR=$(tc-getAR) \
		\
		$(usex system-crystal " " PATH="${WORKDIR}"/${PN}-${BV}/bin:"${PATH}") \
		CRYSTAL_PATH=src \

...
microsoft.identity.client.extensions.msal@4.82.0
...
microsoft.sqlserver.dacfx.projects@0.6.24-preview
microsoft.sqlserver.dacfx@162.3.563
microsoft.sqlserver.dacfx@170.2.70
microsoft.sqlserver.dacfx@170.5.38-preview
microsoft.sqlserver.dacfx@170.5.80-preview
microsoft.sqlserver.management.smometadataprovider@181.25.0
microsoft.sqlserver.management.sqlparser@180.0.0
microsoft.sqlserver.management.sqlparser@180.4.0
...
PATCHES=(
	"${FILESDIR}"/disable-CA2263-prefer-generic-overload-when-type-is-known.patch
	"${FILESDIR}"/force-rid-graph.patch
)
...
DOTNET_PKG_RESTORE_EXTRA_ARGS=(
	-p:SqlCoreDotNetVersion=net$DOTNET_PKG_COMPAT
)

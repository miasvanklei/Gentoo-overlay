...
src_prepare() {
	...
	APPHOST_PACK="packs/Microsoft.NETCore.App.Host.${TARGET}/current/runtimes/${TARGET}/native"
	ARTIFACTS_COREFX="${S}/artifacts/bin/native/linux-${DARCH}-Release"
	ARTIFACTS_CORECLR="${S}/artifacts/bin/coreclr/linux.${DARCH}.Release"

	ARTIFACTS_CORESETUP="${S}/artifacts/bin/linux-musl-${DARCH}.Release/corehost"

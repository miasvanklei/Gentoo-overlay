...
KEYWORDS="~amd64"
IUSE="cups custom-cflags gnome gnome-keyring kerberos lto neon pic +proprietary-codecs pulseaudio selinux +system-ffmpeg"
...
src_configure() {
	...
	if tc-is-clang; then
		myconf_gn+=" is_clang=true clang_base_path=\"/usr/lib/llvm/6\" clang_use_chrome_plugins=false"
	else

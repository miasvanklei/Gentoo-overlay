...
RDEPEND="dev-haskell/aeson:=[profile?]
	...
	dev-haskell/heapsize:=[profile?]
	>=dev-haskell/hie-bios-0.7.1:=[profile?] <dev-haskell/hie-bios-0.8:=[profile?]
	dev-haskell/hie-compat:=[profile?]
	dev-haskell/hslogger:=[profile?]
	dev-haskell/hls-plugin-api:=[profile?]
	>=dev-haskell/implicit-hie-cradle-0.3.0.2:=[profile?] <dev-haskell/implicit-hie-cradle-0.4.0.0:=[profile?]
